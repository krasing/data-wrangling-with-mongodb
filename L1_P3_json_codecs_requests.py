...
API_KEY = { "popular": "6a752f5ac34ca8a9e0c9a7855729be9c:2:62164830",
            "article": "b7de30cc12cff5390a98292043246857:10:62164830"}
...
def article_overview(kind, period):
    ...
    for item in data:
        ...
        for media in item['media']:
            for media_metadata in media['media-metadata']:
...
if __name__ == "__main__":
    test()
    #json_out = get_popular(URL_POPULAR, "viewed", 1)
    #save_file('viewed', 7)
    #data = json.loads(json_out['results'])
